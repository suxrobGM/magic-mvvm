...
public static class DialogManagerExtensions
{
    ...
    /// <exception cref="InvalidOperationException">Throws exception if <paramref name="dialogName"/> was not registered in internal registrar</exception>
    public static void Show(this IDialogManager dialogManager, string dialogName, IParameters parameters)
    {
    ...
    /// <param name="parameters">>The parameters to pass to the dialog.</param>
    /// <exception cref="InvalidOperationException">Throws exception if <paramref name="dialogName"/> was not registered in internal registrar</exception>
    public static void ShowDialog(this IDialogManager dialogManager, string dialogName, IParameters parameters)
    {
