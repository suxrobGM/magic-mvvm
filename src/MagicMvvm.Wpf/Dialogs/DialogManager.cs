...
public class DialogManager : IDialogManager
{
    ...
    public void Show(string dialogName, IParameters parameters, Action<IDialogResult> callback, string windowName)
    {
        ShowDialogInternal(dialogName, parameters, callback, false, windowName);
    }

    public void ShowDialog(string dialogName, IParameters parameters, Action<IDialogResult> callback, string windowName)
    {
        ShowDialogInternal(dialogName, parameters, callback, true, windowName);
    }

    private void ShowDialogInternal(string dialogName, IParameters parameters, Action<IDialogResult> callback, bool isModal, string windowName = null)
    {
    ...
    protected virtual void ConfigureDialogWindowEvents(IDialogHostWindow hostWindow, Action<IDialogResult> callback, IParameters parameters)
    {
